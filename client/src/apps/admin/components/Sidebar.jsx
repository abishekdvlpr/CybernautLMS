...
useEffect(() => {
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-black text-black dark:text-white">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-sm transition-transform transform ${
          ...
          <div>
            ...
            {showBatchSubmenu && selectedBatchId && (
              <div className="ml-8 mt-2 space-y-1">
                {["lesson-plan", "report", "quiz", "code", "batch-evaluation", "chat"].map(
                  (item) => (
                    <NavLink
                      key={item}
